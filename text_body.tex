...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
Here, $\mathbf{A}$ is the so-called dynamical matrix, $\omega^2$ is the eigenvalue — often referred to as an \emph{eigenfrequency} — and $\Psi$ is the corresponding eigenvector representing the mode shape.
